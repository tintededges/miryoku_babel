...
#+NAME: thumbs-flip
| U_NP | U_NP | DEL  | BSPC | ENT  | SPC  | TAB  | ESC  | U_NP | U_NP |
...
: U_NP,               U_NP,              U_LT("Tab", U_MEDIA),U_LT("Esc", U_MOUSE),U_LT("Space", U_NAV),U_LT("Enter", U_SYM),U_LT("Bckspc", U_NUM),U_LT("Delete", U_FUN),U_NP,                       U_NP
