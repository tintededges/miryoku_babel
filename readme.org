...
The layout is as follows (awkwardly formatted to avoid interferring with the file parsing):

- 1, 2, 3, 4, exit_gaming_layer
- shift, a, w, d, f
- ctrl, q, s, e, tab
- esc, ctrl, space
...
Fork it, edit readme.org, and use the "build" action in the "actions" tab. Once it's done, you can refresh and download the zip file. 
