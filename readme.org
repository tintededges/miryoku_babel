...
| 1    | 2    | 3    | 4    | TAB           |
| SHIFT| S    | W    | D    | Q             |
| 7    | 8    | S    | F    | U_TOG(U_BASE) |
| U_NP | U_NP | ESC  | SPC  | CTRL          |
...
<<table-layer-half(current_layer_name="U_GAME", opposite_layer_name="U_MOUSE", half_table=game-r, mode="l")>>
