...
This repo adds a layer, named "GAME", which is activated with the upper right button of the functions ("FUN") layer. 
The button toggles the layer until the same button is hit again.

The personal_layout branch contains some further customizations, like swapping the two innermost thumb keys.

The layout is detailed [[#game][in the "game" layer below]]. "TG(U_GAME)" toggles the gaming layer.

To make your own changes based off of this, you can check out https://github.com/tintededges/miryoku_babel-Gaming-layer

Fork this, edit readme.org, and use the "build" action in the "actions" tab. Once it's done, you can refresh and download the zip file. 
After that, unzip it and find the folder for you, e.g. ZMK, into the "/miryoku/miryoku_babel/" directory in your main miryoku repo.

Currently only QMK and ZMK are supported, because I couldn't find the command to toggle a layer for other formats. 
You can fix this by searching the babel "readme.org" for "&tog U_GAME" to find where these translations are written, and figure out how to do that for your format. 
...
#+NAME: thumbs
| U_NP  | U_NP  | ESC   | TAB   | SPC   | BSPC  | ENT   | DEL   | U_NP  | U_NP  |
...
| U_NP     | U_NP      | U_MEDIA     | U_MOUSE    | U_NAV   | U_SYM | U_NUM      | U_FUN       | U_NP      | U_NP     |
...
#+NAME: mouse-r
| U_RDO      | U_PST      | U_CPY      | U_CUT      | U_UND      |
| TG(U_GAME) | MS_L       | MS_D       | MS_U       | MS_R       |
|            | WH_L       | WH_D       | WH_U       | WH_R       |
| BTN1       | BTN2       | BTN3       | U_NP       | U_NP       |


*** Button

#+NAME: button
| BOOT      | U_CUT     | U_CPY     | U_PST     | U_RDO      | U_RDO      | U_PST     | U_CPY     | U_CUT     | BOOT      |
| LGUI      | LALT      | LCTL      | LSFT      | TG(U_GAME) | TG(U_GAME) | LSFT      | LCTL      | LALT      | LGUI      |
| U_UND     | U_CUT     | U_CPY     | U_PST     | U_RDO      | U_RDO      | U_PST     | U_CPY     | U_CUT     | U_UND     |

#+NAME: button-thumbs
| U_NP  | U_NP  | BTN3  | BTN2  | BTN1  | BTN1  | BTN2  | BTN3  | U_NP  | U_NP  |
...
#+NAME: thumbs-flip
| U_NP | U_NP | DEL  | ENT  | BSPC | SPC  | TAB  | ESC  | U_NP | U_NP |
...
| LGUI     | LALT      | LCTL        | LSFT       |       |         | LSFT       | LCTL        | LALT      | LGUI     |
| U_BUTTON | ALGR      | LOCK_OPP    | LOCK_CUR   |       |         | LOCK_CUR   | LOCK_OPP    | ALGR      | U_BUTTON |
| U_NP     | U_NP      | U_FUN       | U_NUM      | U_SYM | U_NAV   | U_MOUSE    | U_MEDIA     | U_NP      | U_NP     |
...
: U_NP,               U_NP,              U_LT("Tab", U_MEDIA),U_LT("Esc", U_MOUSE),U_LT("Space", U_NAV),U_LT("Bckspc", U_SYM),U_LT("Enter", U_NUM),U_LT("Delete", U_FUN),U_NP,                       U_NP
